...
- Burp-only manifest: `plugins/codex/services.burp.json`
- Codex wrapper CLI: `plugins/codex/src/cli.ts`
...
```bash
node --experimental-transform-types plugins/codex/src/cli.ts export --manifest plugins/codex/services.burp.json
...
```bash
node --experimental-transform-types plugins/codex/src/cli.ts start --manifest plugins/codex/services.burp.json
```
